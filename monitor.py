        ...
        for h in sub:
            if h['host'] == h_name and h['subnet_name'] == sub_name:
                ...
                if len(h['container_lb_list']) == 0:
                    ...
                    subprocess.call(shlex.split(' sudo  /home/ece792/AutoScalingAsAService/loadBalanceBaseRep.sh '+str(int(n_rules)-int(n_pack))+' '+base_ns+' 1025  '+total_len+' ' +grp[0]['name']))
                    subprocess.call(shlex.split('ssh ece792@172.16.12.12 sudo  /home/ece792/AutoScalingAsAService/loadBalanceBaseRep.sh '+str(int(n_rules)-int(n_pack))+' '+base_ns+' 1025  '+total_len+' ' +grp[0]['name']))
