...
ip netns exec Provider iptables -t filter -D FORWARD -i ens4 -o Prov$1 -j ACCEPT
ip netns exec Provider iptables -t filter -D FORWARD -o ens4 -i Prov$1 -j ACCEPT
